...
export default function LayerControls({activeTool}: {activeTool: string|null}) {
  ...
  return (
    <div className={`${activeTool === "image" ? "absolute text-white rounded-2xl bg-[#1f1f2b] p-3 shadow-xl left-3 top-1/4 z-20" : ""}`} >
      ...
      <div className="flex max-[768px]:flex-col max-[768px]:gap-2 gap-3 mt-2">
        <div
          className="icon-background max-[768px]:flex max-[768px]:justify-center content-center p-0.5 rounded bg-[rgb(51,52,55)]"
          onClick={sendToBack}
        >
        ...
        <div
          className="icon-background max-[768px]:flex max-[768px]:justify-center p-0.5 rounded  bg-[rgb(51,52,55)]"
